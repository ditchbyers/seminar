...
export default async function TextOnlyPage({ searchParams }: { searchParams: Promise<{ table?: string; limit?: string; delay?: string }> }) {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <h1 className="text-2xl font-bold">Text Only <span className="text-gray-400 text-base font-normal">({total} total)</span></h1>
