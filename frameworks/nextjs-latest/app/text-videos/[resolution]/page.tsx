  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <h1 className="text-2xl font-bold">Videos <span className="text-blue-600">{resolution}</span> <span className="text-gray-400 text-base font-normal">({total} total)</span></h1>
